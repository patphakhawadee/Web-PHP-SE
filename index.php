...
<!-- ################################################################################################ -->
  ...
  <section class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace">รายชื่อวิชาที่คุณเรียน</p>
    </div>
...
<i class="fas fa-journal-whills"></i>
        ...
        <?php
            ...
            $id = $_SESSION["userID"];
            $s= "SELECT * FROM `register` INNER JOIN sectiondetail ON register.secID = sectiondetail.secID WHERE userID = '$id'";
             $rest = $pdo->query($s);
                ...
                $i=1;
                    ...
                    while ( $row = $rest->fetch () ) 
                    {
                        ...
                        $r1 = "SELECT * FROM date WHERE secID = '$scid'";
                        $result1 = $pdo->query($r1);
                        $v1 = $result1->fetch ();
...
//                            echo "<li class='one_half'>";
                        ...
                        echo "<li><article><a href='#'><i class='fa fa-book'></i>" . $v["subjID"] . "</a>
                        <h6 class='heading'>" . $v["subjNameEN"] . "</h6>
                        <p>" . $v["subjNameTH"] . "<br><br>" . $v["subjDes"] . "&hellip;<br><br> " . $v1["location"] . "
                        <br><br>" . $v1["startTime"] . " - " . $v1["endTime"] . " น.</p>
                        <footer><a href='#'>ตรวจสอบการเข้าเรียน &raquo;</a></footer>
                        </article>
                        </li>";
